                                    ...
                                    <tr>
                                        <td width="67%" align="right"><font
                                                style="font-family:'Myriad Pro', Helvetica, Arial, sans-serif; color:#68696a; font-size:8px; text-transform:uppercase"><a
                                                    href="http://localhost:8080/linkSharing/showResource?id=${topicId}"
                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td width="80%" align="left" valign="top"><font
                                style="font-family: Georgia, 'Times New Roman', Times, serif; color:#010101; font-size:24px"><strong><em>Hi Dear,</em>
                            </strong></font><br/><br/>
                            <font style="font-family: Verdana, Geneva, sans-serif; color:#666766; font-size:13px; line-height:21px">
                                <p align="justify">                              LinkSharing-Online document management provides an easy, reliable and secure way to share files and folders. It acts as a centralized repository, where you can upload and store all your documents and share them with multiple users in your organization working in different locations.
                                ...
                                Your Friend is Invited to you Join Below Topic.
                                <br /><br />
                                <h4>Click below To Subscribe Topic</h4>
                                <a href="
                                   http://localhost:8080/linkSharing/showResource?id=${topicId}" target="_blank">${topicname}</a>,
                    ...
                    <tr>
                        ...
                        <td width="14%" align="center"><font
                                style="font-family:'Myriad Pro', Helvetica, Arial, sans-serif; color:#010203; font-size:9px; text-transform:uppercase"><a
                                    href="http://localhost:8080/linkSharing/showResource?id=${topicId}"
                                    style="color:#010203; text-decoration:none"><strong>UNSUBSCRIBE</strong></a></font>
                        </td>
                        ...
                        <td width="9%" align="center"><font
                                style="font-family:'Myriad Pro', Helvetica, Arial, sans-serif; color:#010203; font-size:9px; text-transform:uppercase"><a
                                    href="http://localhost:8080/"
                                    style="color:#010203; text-decoration:none"><strong>ABOUT</strong></a></font></td>
                        <td width="2%" align="center"><font
                                style="font-family:'Myriad Pro', Helvetica, Arial, sans-serif; color:#010203; font-size:9px; text-transform:uppercase"><strong>|</strong>
                        </font></td>
                        <td width="10%" align="center"><font
                                style="font-family:'Myriad Pro', Helvetica, Arial, sans-serif; color:#010203; font-size:9px; text-transform:uppercase"><a
                                    href="http://localhost:8080/"
                                    style="color:#010203; text-decoration:none"><strong>PRESS</strong></a></font></td>
                        <td width="2%" align="center"><font
                                style="font-family:'Myriad Pro', Helvetica, Arial, sans-serif; color:#010203; font-size:9px; text-transform:uppercase"><strong>|</strong>
                        </font></td>
                        <td width="11%" align="center"><font
                                style="font-family:'Myriad Pro', Helvetica, Arial, sans-serif; color:#010203; font-size:9px; text-transform:uppercase"><a
                                    href="http://localhost:8080/"
                                    style="color:#010203; text-decoration:none"><strong>CONTACT</strong></a></font></td>
                        <td width="2%" align="center"><font
                                style="font-family:'Myriad Pro', Helvetica, Arial, sans-serif; color:#010203; font-size:9px; text-transform:uppercase"><strong>|</strong>
                        </font></td>
                        ...
                        <td width="4%" align="right"><a href="https://www.facebook.com/" target="_blank"><img
                        ...
                        <td width="5%" align="center"><a href="https://twitter.com/" target="_blank"><img
                                src="http://i414.photobucket.com/albums/pp225/titansgs/PROMO-GREEN2_09_02-1.jpg"
                                alt="twitter" width="23" height="19" border="0"/></a></td>
