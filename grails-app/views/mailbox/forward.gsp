    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                ...
                <!-- /.col -->
                <div class="col-md-9">
                    <form id="forwardEmail" method="post">
                        <div class="box box-primary">
                            <div id="alertmsg10" class="hidden"><span id="spanmsg10" class="col-lg-12"></span></div>

                            <div class="box-header with-border">


                                <h3 class="box-title">Compose New Message</h3>
                                <div id="loaderId10" style="display: none">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <input class="form-control" type="text" required="true" name="subject" value="${resource.topic}Post is Shared By LinkSharing" placeholder="Subject:">
                                </div>
                                <div class="form-group">

                                    Message:
                                <input type="hidden" value="${resource.id}" name="id">
                              <g:render template="/mailbox/readMailTemplate" model="[resource:resource,forwardMail:'forwardMail']"></g:render>
                       </div>
                             </div>
                            <!-- /.box-body -->
                            <div class="box-footer">
                                <div class="pull-left col-lg-offset-8">
...
<script type="text/javascript">
    $("#forwardEmail").submit(function(e)
    {
        $("#loaderId10").show()

        var postData = $(this).serializeArray();
        var formURL = "${g.createLink(action:"sendMail",controller:"user" )}";
        $.ajax(
                {
                    url : formURL,
                    type: "POST",
                    ...
                    success:function(data, textStatus, jqXHR)
                    {
                        if(data.message!="Error During Mail Sending!") {
                            $("#spanmsg10").addClass("alert alert-success")
                            $("#loaderId10").hide();
                        }
                        else
                            $("#spanmsg10").addClass("alert alert-danger")

                        $("#spanmsg10").text(data.message)

                        $("#alertmsg10").toggleClass('hidden');
                        $("#forwardEmail")[0].reset();
                        setTimeout(function(){
                            $("#alertmsg10").toggleClass('hidden');$("#spanmsg10").removeClass("alert alert-success")
                            location.reload();
                        }, 500);
                    ...
                    error: function(jqXHR, textStatus, errorThrown)
                    {
                        ...
                        $("#forwardEmail")[0].reset()
                        setTimeout(function(){$("#alertmsg10").toggleClass('hidden');$("#spanmsg10").removeClass("alert alert-success")}, 3000);
