...
To use KeyTable, first download DataTables ( http://datatables.net/download ) and place the unzipped KeyTable package into a `extensions` directory in the DataTables package. This will allow the pages in the UserProfileAndLockScreen to operate correctly. To see the UserProfileAndLockScreen running, open the `UserProfileAndLockScreen` directory in your web-browser.
